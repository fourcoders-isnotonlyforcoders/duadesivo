      ...
      <FirstContainer>
        <Infos>
          <Contacts>
            ...
            <Container>
              <Contact data-aos= "fade-right" data-aos-duration= "600">duadesivooficial@gmail.com</Contact>
              <Contact data-aos= "fade-right" data-aos-duration= "700">+55 15 99821-6723</Contact>
            </Container>
          </Contacts>
          ...
          <Socials>
            ...
            <LinksContainer>
              <Link href="#" data-aos= "fade-right" data-aos-duration= "700">
              ...
              <Link href="#" data-aos= "fade-left" data-aos-duration= "700">
